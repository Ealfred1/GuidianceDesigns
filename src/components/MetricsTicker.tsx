...
const metrics = [
  "FIGMA", "FIGJAM", "USER RESEARCH", "WIREFRAMING", "PROTOTYPING", "DESIGN SYSTEMS", "UI DESIGN", "USER FLOWS",
  "USABILITY TESTING", "INFORMATION ARCHITECTURE", "INTERACTION DESIGN", "RESPONSIVE DESIGN", "ANALYTICS", "MIXPANEL", "GOOGLE ANALYTICS", "ADAPTABILITY"
];
